...
const reviewArray = [
  ...
  },
  {
    ...
    answer: "Melanie is pursuing(persuu-ing) a career in medecine.",
  },
  {
    id: 608,
    question:
  ...
  {
    id: 634,
    question: "Sarah a senti une agitation d'excitation.",
  ...
  },
  {
    id: 661,
    question:
      "Kenneth est infatigable et travaille souvent tard dans la nuit.",
    answer: "Kenneth is tireless and often works late into the night.",
  },
  {
    id: 662,
    question:
      "Le père de Nan était menuisier et lui a appris le métier.",
    answer: "Nan's father was a woodworker, and she learned the craft from him.",
  },
  {
    id: 663,
    question:
      "La pluie a diminué après quelques minutes donc Tom a décidé de rentrer à pied.",
    answer: "The rain lessened after a few minutes, so Tom decided to walk home.",
  },
  {
    id: 664,
    question:
      "La production de cereales etait basse cette anne a cause de la secheresse.",
    answer: "Gran production was low this year because of the drought(draut).",
  },
  {
    id: 665,
    question:
      "Le vieux moulin servait à moudre le blé au 19e siècle.",
    answer: "The old windmill was used to grind(graint) wheat back in the 19th century.",
  },
  {
    id: 666,
    question:
      "Le vieil hôtel était effrayant et probablement hanté.",
    answer: "The old hotel was scary and probably haunted(hontet).",
  },
  {
    id: 667,
    question:
      "La préservation/conservation de l'énergie est un thème majeur de la conférence.",
    answer: "Conservation of energy is a major theme(fim) of the conference.",
  },
  {
    id: 668,
    question:
  ...
  },
  {
    id: 669,
    question:
      "Les vaches boivent depuis l'étang du champ.",
    answer: "The cows drink from the pond of the field.",
  },
  {
    id: 670,
    question:
      "Ma caracteristique favorite the ce cuir est sa douce texture.",
    answer: "My favorite feature(fitche) of this leather is its smooth(smuuud) texture.",
  },
  {
    id: 671,
    question:
      "[Coding] : How does localStorage in Javascript works?",
    answer:
      "We setItem() like this: localStorage(nameOfKey, JASON.stringify(nameOfValue)), we getItem() like: JASON.parse(localStorage.getItem(nameOfKey)), for remove is like: localStorage.removeItem(nameOfKey)",
  },
  {
    id: 672,
    question:
      "[Coding] : What is that mean ? window.pageYOffset",
    answer:
      "It will get the number of px when we scroll down.",
  },
  {
    id: 673,
    question:
      "[Coding] : What is that mean ? header.offsetHeight",
    answer:
      "We will get the height of the whole element <header> ",
  },
  {
    id: 674,
    question:
  ...
  },
  {
    id: 675,
    question:
      "[Coding] : What are the 2 types of data in React? ",
    answer:
      "Props and State ",
  },
  {
    id: 676,
    question:
      "[Coding] : What is an Emmet? ",
    answer:
      "Emmet is the shortcut to write an element with directly a class, ex: div.container.",
  },
  {
    id: 677,
    question:
      "[Coding] : What is an API ?",
    answer:
      "API stands for: Application Program Interface, is the way for programs to communicate with other programs.",
  },
  {
    id: 678,
    question:
      "[Coding] : What is an async function ?",
    answer:
      "Is a function that happens asynchronously, is a function where you execute something that you have to wait for the server's answers and will comeback with a promise, which means it will returns something.",
  },
  {
    id: 679,
    question:
      "[Coding] : What is the useEffect Hook in React ?",
    answer:
      "Is actually the same then class component live cycle method but just for function component. Must be declared at the body from the function and we pass a 1st param that will be an arraw function and the 2nd one have to be an array and inside we have to mark there the condition what we should wait to re-render.",
  },
  {
    id: 680,
    question:
      "[Coding] : What is component didMount in React ?",
    answer:
      "(a utiliser sur un composent de type class) : celle qui se lance qu'une seule fois au chargement/render.",
  },
  {
    id: 681,
    question:
      "[Translate in Jap] : The cat looks to feel sleeping well.",
    answer:
      "猫が気持ち良さそうに寝ています。",
  },
  {
    id: 682,
    question:
      "[Translate in Jap] : It looks to be well.",
    answer:
      "よさそうだ。",
  },
  {
    id: 683,
    question:
      "[Translate in Jap] : I want to fly like a bird.",
    answer:
      "鳥のように空を飛びたい。（we use ように cuz it's related to the verb)",
  },
  {
    id: 684,
    question:
      "[Translate in Jap] : I cleaned up the room (in advance) because my friend is coming tomorrow.",
    answer:
      "明日友達が来るので、今日、部屋の掃除をしておきました。",
  },
  {
    id: 685,
    question:
      "[Translate in Jap] : When we do we should use てform + しまう。",
    answer:
      "1.To express completation of an action. 2.express also feeling of regret",
  },
  {
    id: 686,
    question:
      "[Translate in Jap] : Did you read that difficult book in 3 days. Amazing!",
    answer:
      "あの難しい本を三日（みか）で読んでしまったのですか。すごいですね！",
  },
  {
    id: 687,
    question:
      "[Translate in Jap] : Although before the exam i got a cold. (regret)",
    answer:
      "試験の前なのに風邪を引いてしまいました。",
  },
  {
    id: 688,
    question:
      "[Translate in Jap] : Excuse me! Is it possible to try this coat ?",
    answer:
      "すみません。。そのコート、ちょっと来て見てもいいですか。",
  },
  {
    id: 689,
    question:
      "[Translate in Jap] : Do you ate for real 6 ice cream. You eat to much.",
    answer:
      "アイスクリームを六つも食べたんですか。食べすぎですよ。",
  },
  {
    id: 690,
    question:
      "[Translate in Jap] : This book is difficult because, also heigh level students were probably not able to reat it.",
    answer:
